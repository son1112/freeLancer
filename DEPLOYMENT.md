...
sudo service unicorn_freeLancer <start|stop|restart>
sudo service sidekiq_freeLancer <start|stop>
```
...
```
/home/deployer/apps/freeLancer/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_freeLancer restart
sudo service sidekiq_freeLancer stop
sudo service sidekiq_freeLancer start
```
